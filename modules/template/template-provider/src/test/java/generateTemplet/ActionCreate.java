...
public class ActionCreate {
    public static void createModel(Map<String, String> cus, List<Model> models,String createOrDelete) {
        ...
        sb.append("package com.bjike.reborn." + packageName + ".action." + (packageName+(relativePath.equals("")?"":"."+relativePath)).replaceAll("/",".") + ";\n\n")
                .append("import com.bjike.reborn.common.api.exception.ActException;\n")
                .append("import com.bjike.reborn.common.api.exception.SerException;\n")
                .append("import com.bjike.reborn.common.consumer.restful.ActResult;\n")
        ...
        StringBuffer filePath = new StringBuffer(System.getProperty("user.dir") + "/modules/")
                ...
                .append(packageName.toLowerCase() + "-consumer/src/main/java/com/bjike/reborn/")
