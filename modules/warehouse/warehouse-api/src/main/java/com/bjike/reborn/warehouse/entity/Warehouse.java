package com.bjike.reborn.warehouse.entity;
...
public class Warehouse extends BaseEntity {
     ...
     * 仓库名
     */
    @Column(nullable = false, columnDefinition = "VARCHAR(50)   COMMENT '仓库名'")
    private String name;

    /**
     * 仓库类型
     */
    @Column(nullable = false, columnDefinition = "TINYINT(2) COMMENT '仓库类型'")
     ...
     * 省份
     */
    @Column( columnDefinition = "VARCHAR(50)   COMMENT '省份'")
